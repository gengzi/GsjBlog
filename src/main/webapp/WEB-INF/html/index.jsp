...
<body class="gray-bg top-navigation">
            ...
            <div class="row border-bottom white-bg">
                <nav class="navbar navbar-static-top navbar-fixed-top" role="navigation">
                    ...
                    <!--        <li class="active">
                            ...
                            <li class="dropdown">
                                <a aria-expanded="false" role="button" href="#" class="dropdown-toggle" data-toggle="dropdown"> 博客 <span class="caret"></span></a>
 ...
 -->                        <div class="space-16"></div>
                            ...
                            <ul class="folder-list m-b-md" style="padding: 0">
                                ...
                                <li>
                                    <a href="mailbox.html"> <i class="fa fa-trash-o"></i> 开发软件</a>
                                </li>
                            </ul>
                            <h5>分类</h5>
